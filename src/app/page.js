    ...
    <div className="container-fluid rest d-flex">
        <div className="menu-links">
            <ul className="main-menu rest">
                ...
                <li>
                    <div className="o-hidden">
                        <a href="../inner_pages/contact.html" className="link"><span className="fill-text" data-text="Contact Us">Contact Us</span></a>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <main>
                    ...
                    <div className="sec-head mb-100">
                        <div className="row">
                            ...
                            <div className="col-lg-7">
                                ...
                                <a href="../inner_pages/services.html" className="butn butn-md butn-bord butn-rounded mt-40">
                                    <div className="d-flex align-items-center">
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ml-auto">
                                            <div className="icon invert">
                                                <img src="/asserts/images/bezier-curve-solid.svg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="text">
                            ...
                            <div className="item md-mb50">
                                <div className="cont">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ml-auto">
                                            <div className="icon invert">
                                                <img src="/asserts/images/code-solid.svg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="text">
                            ...
                            <div className="item">
                                <div className="cont">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ml-auto">
                                            <div className="icon invert">
                                                <img src="/asserts/images/chart-line-solid.svg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="text">
                        ...
                        <div className="col-lg-4 offset-lg-1 valign">
                            <div className="sec-head">
                                ...
                                <h4>We help passionate Founders perfect theirs design &amp; development game.
                                    <span className="sub-color inline">Let’s aim for the <br/> top together!</span>
                                </h4>
                                <a href="../inner_pages/about.html" className="butn butn-md butn-bord butn-rounded mt-40">
                                    <div className="d-flex align-items-center">
            ...
            <section className="work-card">
                <div className="container section-padding bord-thin-top-light">
                                    ...
                                    <div className="cont md-mb50">
                                        ...
                                        <div>
                                            <p>This paragraph is short description to describe about this project,
                                                ...
                                                project</p>
                                            <div className="mt-40">
                                                <a href="#0" className="tag">Mobile Responsive</a>
                                                <a href="#0" className="tag">UX Design</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-5">
                                    <div className="cont md-mb50">
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-40">
                                                <a href="#0" className="tag">UI/UX</a>
                                                <a href="#0" className="tag">Webflow</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="text-center mt-80">
                        <a href="../inner_pages/portfolio-cards.html" className="butn butn-md butn-bord butn-rounded">
                            <div className="d-flex align-items-center">
            ...
            <section className="awards-sa section-padding">
                <div className="container">
                    ...
                    <div className="text-center mt-80">
                        <a href="../inner_pages/about.html" className="butn butn-md butn-bord butn-rounded">
                            <div className="d-flex align-items-center">
                                <span>Show More</span>
                                <span className="icon pe-7s-angle-right ml-10 fz-30"></span>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-7">
                                <h4>The place that we share everything related to
                                    <span className="sub-color inline">design trends, tips and more.</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="box">
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="info">
                                    <div className="sec-head">
                                        <h4>Success is a team play, right? <span className="sub-color inline">Let’s work
                                                together!</span></h4>
                                    </div>
                                    <div className="mt-50 md-mb80">
                                        <h6>+068 5681 96 96</h6>
                                        <span className="d-block sub-color fz-14 mt-10">Call us for urgent</span>
                                        <a href="../inner_pages/contact.html" className="butn butn-md butn-bord butn-rounded mt-50">
                                            <div className="d-flex align-items-center">
                                        ...
                                        <div className="controls row">
                                            ...
                                            <div className="col-lg-6">
                                                <div className="form-group mb-30">
                                                    ...
                                                    <input id="form_budget" type="text" name="budget" placeholder="A range of budget for project" required="required" />
                                                </div>
                                            </div>
